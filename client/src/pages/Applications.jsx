  ...
  return (
    <>
      ...
      <div className="container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10">
        ...
        <div className="flex gap-2 mb-6 mt-3">
          {isEdit || (userData && userData.resume === '') ? (
            <>
              ...
              <button onClick={updateResume} className="bg-green-100 border border-green-400 px-4 py-2 rounded-lg">
                Save
              </button>
            </>
          ) : (
        ...
        <h2 className="text-xl front-semibold mb-4">Job Applied</h2>
        <table className="min-w-full bg-white border rounded-lg">
          <thead>
            <tr>
              <th className="py-3 px-4 border-b text-left">Company</th>
              <th className="py-3 px-4 border-b text-left">Job Title</th>
              <th className="py-3 px-4 border-b text-left msx-sm:hidden">Location</th>
              <th className="py-3 px-4 border-b text-left msx-sm:hidden">Date</th>
