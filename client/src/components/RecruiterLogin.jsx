  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex items-center justify-center">
      <form onSubmit={onSubmitHandler} className="relative bg-white p-10 rounded-xl  text-slate-500">
        <h1 className="text-2xl text-center text-neutral-700 font-medium">Recruiter {state}</h1>
        ...
        {state === 'Login' && <p className="text-xs text-blue-600 mt-4 cursor-pointer">Forgot password?</p>}
